...
public class EntertainmentActivity extends AppCompatActivity implements NewsAdapter.onSelectData {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(EntertainmentActivity.this, "Gagal menampilkan data!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(EntertainmentActivity.this, "Tidak ada jaringan internet!", Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void showNews() {
        newsAdapter = new NewsAdapter( modelNews, EntertainmentActivity.this,this);
        rvEntertaiment.setAdapter(newsAdapter);
    }

    @Override
    public void onSelected(ModelNews mdlNews) {
        startActivity(new Intent(EntertainmentActivity.this, OpenNewsActivity.class).putExtra("url", mdlNews.getUrl()));
    }
